namespace ArtTrail.Data.Migrations.Helpers
{
    ...
    internal static class ArtistSeedHelper
    {
        ...
        public static void PopulateArtists(ArtTrailDataContext dataContext)
        {
            ...
            artist.AddPainting(new Painting { PaintingName = "Painting1Name", PaintingDescription = "Painting1Desc", PaintingUrl = "Painting1Url" });
            artist.AddPainting(new Painting { PaintingName = "Painting2Name", PaintingDescription = "Painting2Desc", PaintingUrl = "Painting2Url" });
            ...
            artist2.AddPainting(new Painting { PaintingName = "Painting3Name", PaintingDescription = "Painting3Desc", PaintingUrl = "Painting3Url" });
            artist2.AddPainting(new Painting { PaintingName = "Painting4Name", PaintingDescription = "Painting4Desc", PaintingUrl = "Painting4Url" });
