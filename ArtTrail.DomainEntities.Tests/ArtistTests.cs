namespace ArtTrail.DomainEntities.Tests
{
    ...
    public class ArtistTests
    {
        ...
        public void ArtistShouldHaveADescription()
        {
            ...
            new PropertyExpectations<Artist>(x => x.ArtistDescription).IsAutoProperty<string>().Result.Should().Be(true);
        }
        ...
        public void ArtistShouldHaveAName()
        {
            ...
            new PropertyExpectations<Artist>(x => x.ArtistName).IsAutoProperty<string>().Result.Should().Be(true);
        }
        ...
        public void ArtistShouldHaveAnId()
        {
            ...
            new PropertyExpectations<Artist>(x => x.ArtistId).IsAutoProperty<int>().Result.Should().Be(true);
        }
